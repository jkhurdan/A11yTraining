...
<details>
  <summary> VoiceOver - desktop testing </summary>
    ...
    <table> 
      ...
      <tr>
        <td> VO Key (Ctrl + Option) + Left/Right arrow key </td> 
        <td> This will navigate to the next (or previous element) </td>
      </tr>
      <tr>
        <td> VO Key (Ctrl + Option) + Down arrow </td>
        <td> Enters into an element, like a web page, web frame, table, etc </td>
      </tr>
    </table>
</details>
